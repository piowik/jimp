...
#include "../../../../../MinGW/lib/gcc/mingw32/5.3.0/include/c++/algorithm"
...
namespace datastructures {
    ...
    /* niepotrzebne? word i counts maja zdefiniowane <
     * struct less_than_sort
    {
        inline bool operator() (const std::pair<Word, Counts> &s1, const std::pair<Word, Counts> &s2)
        {
            return (s1.second.GetCount() < s2.second.GetCount());
        }
    };*/
